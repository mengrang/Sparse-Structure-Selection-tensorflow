...
THRESHOLD = 5e-5
@tf_export("train.Softhre_MomentumOptimizer")
class Softhre_MomentumOptimizer(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate, momentum,
    ...
    @end_compatibility
    """
    super(Softhre_MomentumOptimizer, self).__init__(use_locking, name)
    self._learning_rate = learning_rate
    self._momentum = momentum
    self._use_nesterov = use_nesterov

  def soft_tfresholding(input, thr):
